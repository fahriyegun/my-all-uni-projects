%Question 3 
% Implementing a natural boundary cubic spline drawing program using MATLAB.


noi = input('Please enter how many number will you enter: ');
%get number of inputs from user
grid on; %open grits
%to get good graph numbers should be big so intervals are arrenged again
xlim([0 100]);
ylim([0 100]);
[x,y] = ginput(noi);

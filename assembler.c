...
//========================================   FIRST PASS  ======================================================
			while (token)
			{
				...
				{
					//st[opcode15:12], op2[8:6], op1[5:3] 
					op1 = strtok(NULL,"\n\t\r ");
					op2 = strtok(NULL,"\n\t\r ");
					chch = (((op2[0]-48)<< 6) | ((op1[0]-48)<<3)); //shift 6 bits to op2, 3 bits to op1
					program[counter]=0x3000+((chch)&0x01ff);	   //form the instruction of st and write it to memory
					counter++;
				}
				...
				{
					// add[opcode 15:12], alu select[000], src[8:6], src[5:3], dst[2:0] 
					op1 = strtok(NULL,"\n\t\r ");    
					op2 = strtok(NULL,"\n\t\r ");
					op3 = strtok(NULL,"\n\t\r ");
				...
				{
					// sub[opcode 15:12], alu select[001], src[8:6], src[5:3], dst[2:0] 
					op1 = strtok(NULL,"\n\t\r ");    
					op2 = strtok(NULL,"\n\t\r ");
					op3 = strtok(NULL,"\n\t\r ");
				...
				{
					// and[opcode 15:12], alu select[010], src[8:6], src[5:3], dst[2:0] 
					op1 = strtok(NULL,"\n\t\r ");    
					op2 = strtok(NULL,"\n\t\r ");
					op3 = strtok(NULL,"\n\t\r ");
					chch = (op1[0]-48)| ((op2[0]-48)<<6|((op3[0]-48)<<3));  
				...
				{
					// or[opcode 15:12], alu select[011], src[8:6], src[5:3], dst[2:0] 
					op1 = strtok(NULL,"\n\t\r ");    
					op2 = strtok(NULL,"\n\t\r ");
					op3 = strtok(NULL,"\n\t\r ");
					chch = (op1[0]-48)| ((op2[0]-48)<<6|((op3[0]-48)<<3));  
				...
				{
					// xor[opcode 15:12], alu select[100], src[8:6], src[5:3], dst[2:0] 
					op1 = strtok(NULL,"\n\t\r ");    
					op2 = strtok(NULL,"\n\t\r ");
					op3 = strtok(NULL,"\n\t\r ");
					chch = (op1[0]-48)| ((op2[0]-48)<<6|((op3[0]-48)<<3));  
				...
				{
					// not[opcode 15:12], alu select[111000], src[5:3], dst[2:0] 
					op1 = strtok(NULL,"\n\t\r ");
					op2 = strtok(NULL,"\n\t\r ");
				...
				{
					//mov[opcode 15:12], alu select[111001], src[5:3], dst[2:0] 
					op1 = strtok(NULL,"\n\t\r ");
					op2 = strtok(NULL,"\n\t\r ");
					ch = (op1[0]-48)| ((op2[0]-48)<<3);
				...
				{
					// inc[opcode 15:12], alu select[111010], src[5:3], dst[2:0] 
					op1 = strtok(NULL,"\n\t\r ");
				...
				{
					// dec[opcode 15:12], alu select[111011], src[5:3], dst[2:0] 
                    op1 = strtok(NULL,"\n\t\r ");
					ch = (op1[0]-48)| ((op1[0]-48)<<3);
				...
				{
					// push[opcode 15:12], dst[2:0]
					op1 = strtok(NULL,"\n\t\r ");
					ch = (op1[0]-48);
					program[counter]=0x9000+((ch)&0x00ff);  //&0x0007
					counter++;
				}
				else if (strcmp(token,"call")==0) //------------CALL----------------------------------------------
				{
					// call[opcode 15:12], address[11:0]				call instruction works like jump instruction
					op1 = strtok(NULL,"\n\t\r ");
				...
				else if (strcmp(token,"sti")==0) //------------------STI INSTRUCTION--------------------
				{
					op1 = strtok(NULL,"\n\t\r ");                               
                ...
                else if (strcmp(token,"cli")==0) //------------------CLI INSTRUCTION--------------------
				{
					op1 = strtok(NULL,"\n\t\r ");                                
                ...
                else if (strcmp(token,"iret")==0) //------------------IRET INSTRUCTION--------------------
				{
					op1 = strtok(NULL,"\n\t\r ");                                
 		...
 		while(fgets(line,sizeof line,fp)!= NULL)
		{
			...
			{				
				...
				else if (strcmp(token, ".space")==0)
				{
					...
					int i;
					for(i=1;i<dataarea-j;i++)
					{
						program[counter+j+i]=0;
					}
					dataarea--;
				}
